...
# Dosya: 06_zamanlanmis_yedekleme.sh
# Açıklama: Cron ile Zamanlayıcı Kurulum ve Otomatik Yedekleme
# ============================================================================
...
# ============================================================================
# 1. Otomatik Yedekleme Scripti Oluştur
# ============================================================================
...
#!/bin/bash
# ============================================================================
# Otomatik Yedekleme Scripti - Cron tarafından çağrılır
# Her çalıştığında tarih damgalı yedek alır, eski yedekleri temizler
# ============================================================================
...
# PostgreSQL erişilebilirlik kontrolü
...
cat > "$CRON_FILE" << EOF
# ============================================================================
# PostgreSQL E-Ticaret DB Yedekleme Zamanlayıcı Tanımları
# Kurulum: crontab $CRON_FILE
# Görüntüleme: crontab -l
# ============================================================================
...
# Haftalık tam yedekleme (sıkıştırılmış) - Her Pazar saat 03:00'te
0 3 * * 0 $SCRIPTS_DIR/03_tam_yedekleme.sh >> $LOG_DIR/cron_output.log 2>&1

# Saatlik fark yedekleme (çalışma saatlerinde) - Pazartesi-Cuma, 09:00-18:00
0 9-18 * * 1-5 $SCRIPTS_DIR/04_fark_yedekleme.sh >> $LOG_DIR/cron_output.log 2>&1

# ============================================================================
# CRON ZAMANLAYICI FORMAT:
# ┌───────────── dakika (0-59)
# │ ┌───────────── saat (0-23)
# │ │ ┌───────────── ayın günü (1-31)
# │ │ │ ┌───────────── ay (1-12)
...
# ============================================================================
# 3. Anlık Otomatik Yedekleme Testi
# ============================================================================
